...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.model = self.model_load(weights="runs/train/exp3/weights/best.pt",
    ...
    def detect_img(self):
        ...
        if source == "":
            ...
            for path, im, im0s, vid_cap, s in dataset:
                ...
                dt[0] += t2 - t1
                # Inference
                Visualize = increment_path('test/yolov5-5.0/images/tmp' / Path(path).stem, mkdir=True) if Visualize else False
